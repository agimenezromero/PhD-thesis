...
\begin{enumerate}
	\item \fullcite{GimenezRomero2021}\mybibexclude{GimenezRomero2021}
	      \vspace{0.5 cm}
	\item \fullcite{Flecha2022}\mybibexclude{Flecha2022}
	      \vspace{0.5 cm}
	\item

	      \fullcite{GimenezRomero_2022_RSos}\mybibexclude{GimenezRomero_2022_RSos}
	      \vspace{0.5 cm}
	\item

	      \fullcite{GimenezRomero2022_PRE}\mybibexclude{GimenezRomero2022_PRE}
	      \vspace{0.5 cm}
	\item

	      \fullcite{GimenezRomero2022_CommsBio}\mybibexclude{GimenezRomero2022_CommsBio}
	      \vspace{0.5 cm}
	\item \fullcite{GimenezRomero2023}\mybibexclude{GimenezRomero2023}
	      \vspace{0.5 cm}
	\item

	      \fullcite{GimenezRomero2023_PD}\mybibexclude{GimenezRomero2023_PD}
	      \vspace{0.5 cm}
	\item \fullcite{GimenezRomero2024}\mybibexclude{GimenezRomero2024}
	      \vspace{0.5 cm}
	\item Universal spatial properties of coral reefs
	      \vspace{0.5cm}
	\item

	      \fullcite{GimenezRomero2024_posi}\mybibexclude{GimenezRomero2024_posi}
\end{enumerate}

\chapter*{Other publications}

\begin{enumerate}
	\item \fullcite{Lago2023}\mybibexclude{Lago2023}
	      \vspace{0.5 cm}
	\item

	      \fullcite{Moralejo2023_Phytophthora}\mybibexclude{Moralejo2023_Phytophthora}
	      \vspace{0.5 cm}
	\item A comprehensive dataset on global coral reefs size and
	      geometry
	      \vspace{0.5 cm}
	\item \fullcite{Moralejo2024}\mybibexclude{Moralejo2024}
