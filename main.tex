...
%----------------------------------------------------------------------------------------
\chapterimage{nacra_I.jpg}
\chapterspaceabove{6.75cm}
\chapterspacebelow{7.25cm}

\chapter{Introduction \& Contributions}
\input{Chapters/Intro_nacras.tex}
...
\part{Modelling the spread of vector-borne plant diseases}
...
\chapter{Introduction \& Contributions}
\input{Chapters/Intro_xf_spread.tex}
...
\chapter{Introduction \& Contributions}
\input{Chapters/Intro_xf_risk.tex}
...
\chapter{Introduction \& Contributions}
\input{Chapters/Intro_data_driven.tex}
