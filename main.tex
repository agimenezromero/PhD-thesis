...
\chapter{Reconstructing coastal pH time-series with machine learning}\label{ch:ph}
...
\chapter{Mapping the distribution of seagrass meadows from space}\label{ch:posidonia}
