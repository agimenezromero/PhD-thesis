...
\begin{equation}
    \begin{gathered}
        ...
        S(0)= \\
        P(0)+\frac{\lambda}{\gamma}\parentesi{N-R(0)} -
...
\begin{equation}
    \begin{gathered}
        \Lambda_{1,2}=-{1\over 2}(\gamma+\mu+{{\bar{\beta} S(0)}}\pm \\
        \sqrt{\gamma^2+\mu^2+\left({{\bar{\beta} S(0)}}\right)^2
...
\begin{equation*}
    J=\parentesi{\begin{array}{cc}
            -\gamma & \bar{\beta} S_0        \\
            \lambda & -(\bar{\beta} S_0+\mu)\end{array}}\quad
    T=\parentesi{\begin{array}{cc}
            0 & \bar{\beta} S_0 \\
            0 & 0
        \end{array}} \quad \Sigma=\parentesi{\begin{array}{cc}
            -\gamma & 0                        \\
...
\begin{equation}\label{eq:rate_change}
    \frac{R(T+\Delta T)}{R(T)}=\displaystyle\frac{\exp(a\cdot 100 / (T +
        \Delta T)+b)}{\exp(a\cdot 100/T+b)} = \exp(a \cdot
    \frac{-100}{T+\Delta T}\cdot \frac{\Delta T}{T}) \ .
\end{equation}
