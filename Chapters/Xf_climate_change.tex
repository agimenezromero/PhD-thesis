...
(Online Supplementary Information). Because the temporal resolution
...
(\cref{fig:Xf_Ps_suitability_change} and Online Supplementary Information).
...
(Online Supplementary Information). Conversely, areas of Central
...
winters tend to eliminate any potential summer infection $[\mathcal{G}(CDD) <
            0.3]$ (Online Supplementary Information). Climate change
would further
...
different risk categories naturally emerge: no risk ($r<-0.1$), transition zone
($-0.1\leq r<0.1$), low risk ($0.1\leq r<0.33$), moderate risk ($0.33\leq
    r<0.66$) and high risk ($r\geq0.66$). For further details see the Methods
section and the original paper \cite{GimenezRomero2022_CommsBio} .
...
Online Supplementary Information). This general trend affects each of the risk
categories under the different climate change scenarios
(Online Supplementary Information). Furthermore, we observed that a global
...
Online Supplementary Information). To quantify the potential spread of PD, we
...
zones (\cref{fig:PD_future_risk_zones} and
Online Supplementary Information), increasing from almost 1 km y$^{-1}$ to 5
km y$^{-1}$ as the temperature rises from a +1.5ºC to a +4ºC scenario
(Online Supplementary Information). This acceleration is evident when we
compare that in
...
+4ºC scenario (Online Supplementary Information). Furthermore, our estimates of
PD risk
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.96\textwidth]{Figures/Future_risk_country_and_vineyards.pdf}
...
phytosanitary measures. Overall, our model simulations show a consistent
...
from 18.67\% to 40.35\% (Online Supplementary Information). At country level
Portugal and
...
Online Supplementary Information). Such contrasting patterns in PD risk between
countries
...
Online Supplementary Information), while the percentage of vineyard area at
risk rises
