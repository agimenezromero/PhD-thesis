...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{Figures/individual_reef_analysis_complete.pdf}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{Figures/Box_Counting_Dimensions.pdf}
