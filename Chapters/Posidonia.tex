...
However, if these habitats are degraded, they could leak stored carbon into the
...
(\cref{fig:scheme}a,c, Methods \& Online Supplementary Information). This
dataset was
...
different dates and
satellite positions (\cref{fig:scheme}b,c, Methods \& Supplementary
Information).
...
architecture (\cref{fig:scheme}d, Methods \& Online Supplementary Information).
...
introduced by individual models (Methods \& Supplementary
Information). To evaluate the models, we opted for training only with data from
...
the training set (Methods \& Online Supplementary Information). This approach
was
...
prediction approach (Methods and Online Supplementary Information), which
hereafter we
...
(\cref{fig:model_performance}a, and
Online Supplementary Information). We note that in image segmentation
tasks an IoU score
greater than 50\% is considered an acceptable prediction
\cite{dai2016instance} (yellow stars in \cref{fig:model_performance}a).
...
than 50\% (\cref{fig:model_performance}a and
Online Supplementary Information). This demonstrates that the model is able to
generalize
to some extent to new regions, with different environmental conditions and the
presence of some different benthic habitats.
...
performance (Online Supplementary Information).
...
than to its own class (Online Supplementary Information). Then it is not
surprising that the
...
91.97\% achieved in the training dataset (Online Supplementary Information). At
any
...
respectively (Online Supplementary Information). Finally, we assessed the model
...
(Online Supplementary Information). The images were
...
images with different conditions (Online Supplementary Information).
...
oceanica, green algae, brown algae \& rocks and sandy bottoms (Online
...
(Online Supplementary Information). Because Linknet architecture has less
...
prediction approach in the training and out-of-sample test datasets. All models
achieved high performance, with a median IoU of 88.12\% and F1-score of
93.16\% in the training dataset (Online Supplementary Information), while the
models'
performance in the out-of-sample test dataset was significantly reduced, with a
median IoU of 60.73\% and F1-score of 71.87\% (Online Supplementary
Information). When
...
(Online Supplementary Information), highlighting the effectiveness of the
