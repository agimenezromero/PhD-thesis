...
the past decades, parasites have been continuously emerging \cite{Morens2004,
    Daszak2017}, while globalization and climate change have contributed to
their
...
inducing widespread mass mortality in several species \cite{Eisenlord2016,
...
Modelling parasites and hosts as individual entities allows taking into
...
We generalize the basic reproductive number, that we will refer to as
...
\begin{figure}[H]
    ...
    \caption[Comparison between the non-spatial model and the individual based
        ...
        the final fraction of dead hosts, $R(\infty)/N$, as function of $R_0$
...
\begin{figure}[H]
    ...
    \caption[Analysis of the spreading speed of the infected population]{(a)
        Disease spreading speed as function of the square root of the parasite
...
\begin{figure}[H]
    ...
    \caption[Analysis of the extinction time of the epidemic]{(a) Extinction
        ...
        time as function of the inverse of the parasite mobility. The inset
...
populations can be well described by the non-spatial version of the model
(i.e.,
