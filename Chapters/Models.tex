...
the pH of the oceans. In \cref{ch:ph}, we will present a new method to
...
and time-consuming. In \cref{ch:seagrass}, we will present a new method to
...
In \cref{ch:coral}, we will present a global analysis on the spatial properties
of all tropical coral reefs worldwide, which has unraveled universal patterns
in their size distribution and geometry. This analysis provide important
insights into the ecology of coral reefs and can help to design effective
conservation strategies.

In the following sections, we will briefly introduce the datasets used in each
chapter and the basics of the methods used to solve the problems addressed in
each chapter.
