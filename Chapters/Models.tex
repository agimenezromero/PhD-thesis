...
\begin{algorithm}[H]
  \caption{Choose and apply event}
...
infectious diseases is their spread \textit{at a global level}. Disease
biogeography is the study of the geographical distribution of infectious
diseases and the factors that influence their establishment. This is influenced
by a variety of factors, such as climate, land use, human activities, and the
presence of vectors or reservoirs. Understanding how these factors influence
the establishment of diseases at a geographical scale is essential to predict
the risk of emergent diseases developing in new areas. In this section, we will
discuss the most common methods used to study the potential distribution of
diseases and their limitations, particularly in a context of climate change.

% Ecological niche concept
\subsection{\label{sec:Ecological niches} Ecological niches}

The concept of ecological niches is central to the study of disease
biogeography. An ecological niche is defined as the set of environmental
conditions under which a species can persist and maintain a stable population.
The niche of a species is determined by a variety of factors, such as
temperature, humidity, precipitation, and the presence of other species. The
fundamental niche of a species is the set of environmental conditions under
which a species can persist in the absence of other species. The realized niche
of a species is the set of environmental conditions under which a species can
persist in the presence of other species. The difference between the
fundamental
and realized niches of a species is known as the \textit{niches overlap}, which
is a measure of the degree of competition between species. The concept of
ecological niches is particularly important in the study of disease
biogeography, as it can help to predict the potential distribution of diseases
based on the environmental conditions that favor their establishment.
...
distribution of the species. SDMs are usually based on statistical models that
relate the presence and absence of a species to environmental variables. If
this relation renders successful, the model can be then used to predict the
potential distribution of the species at different locations based on their
environmental conditions. SDMs have been widely used in the study of disease
biogeography, as they can help to predict the potential distribution of
diseases based on the environmental conditions that favor the establishment of
the pathogens and/or vectors that transmit them.

There are several methods that can be used to build SDMs, such as logistic
regression, generalized linear models, and machine learning algorithms, such as
random forests, support vector machines, and artificial neural networks. These
methods have different strengths and weaknesses, and the choice of method
depends on the characteristics of the data and the research question.
