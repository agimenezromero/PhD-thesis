...
\begin{figure}[H]
  ...
  \caption[Example of a species distribution model]{
    ...
    (b) Presemce and modeled pseudo-absence data of the banana slug
    \textit{Ariolimax buttoni} in the west of the United States. (c) Predicted
    potential distribution of the banana slug \textit{Ariolimax buttoni} based
