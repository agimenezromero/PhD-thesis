...
In 2016, the Mediterranean Sea faced an ecological disaster with the onset of a
Mass Mortality Event (MME) affecting the noble fan mussel (*Pinna nobilis*).
This species, the largest endemic bivalve in the Mediterranean, is notable for
its considerable size, reaching up to 1.2 meters in length, and its longevity,
with individuals potentially living for up to 50 years under favorable
conditions. \textit{Pinna nobilis} primarily inhabits coastal and paralic
ecosystems, with a strong association with the seagrass meadows of
\textit{Posidonia oceanica}, which provide the optimal habitat for these
mussels.

The ecological role of \textit{Pinna nobilis} is significant. As a filter
feeder, it plays a crucial part in maintaining water quality by filtering large
amounts of organic matter from suspended detritus. This filtration process
enhances water clarity and supports the overall health of the marine ecosystem.
Furthermore, the shells of \textit{Pinna nobilis} offer habitat and shelter for
a variety of benthic species, thereby contributing to biodiversity. The
species' presence indicates a healthy marine environment, making it an
important ecological indicator.

Unfortunately, the 2016 MME brought a dramatic decline in \textit{Pinna
  nobilis} populations across the Mediterranean. This catastrophic event was
triggered by the protozoan parasite \textit{Haplosporidium pinnae}. The rapid
spread and high mortality rates associated with this parasite caused widespread
concern among marine biologists and conservationists. The disease caused by
\textit{H. pinnae} was unprecedented in its scale and severity, leading to
substantial losses in \textit{Pinna nobilis} populations.

\textit{Haplosporidium pinnae} exhibits a complex life cycle that includes
uninucleate and binucleate cells, plasmodia, and spores, distinguishing it from
other haplosporidans. The parasite's life stages and infection mechanisms are
not completely understood, but it is clear that it can cause severe pathology
in infected mussels. Environmental factors, particularly temperature and
salinity, significantly influence the expression and spread of the disease.
Optimal conditions for the parasite's proliferation are temperatures above
13.5°C and salinity ranges between 36.5 and 39.7 psu. Marine currents also play
a vital role in dispersing the parasite, facilitating its spread across large
areas.

Before the MME, \textit{Pinna nobilis} populations were already under pressure
from various anthropogenic activities, such as habitat destruction, pollution,
and illegal harvesting. The introduction and spread of \textit{H. pinnae}
exacerbated these pressures, pushing the species towards the brink of
extinction. As a result, \textit{Pinna nobilis} is now listed as critically
endangered by the International Union for Conservation of Nature (IUCN).

The MME of \textit{Pinna nobilis} serves as a stark reminder of the
vulnerabilities faced by marine species in the face of emerging diseases and
changing environmental conditions. The event has spurred a concerted effort to
better understand the dynamics of marine diseases, the role of environmental
stressors, and the mechanisms of disease spread. \AG{continue...}
