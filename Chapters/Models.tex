...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{Figures/SDM_example.pdf}
  \caption[Example of a species distribution model]{
    \textbf{Example of a species distribution model.} The figure shows the
    potential distribution of a species based on the environmental conditions
    that favor its establishment. The model uses data on the presence and
    absence of the species in different locations and their environmental
    variables to predict the potential distribution of the species at different
    locations.}
  \label{fig:SDM_example}
\end{figure}

% Referencia figura: https://www.gbif.org/es/occurrence/4510206467

\AG{Explain the example}
