...
\begin{table}
    \centering
    \caption[Ecological categories in the ground truth dataset]{Ecological
        Categories and Subcategories in the ground truth
        habitat data.}
...
\begin{table}[H]
    \centering
    \caption[Performance metrics for the final model in the training
        dataset]{Performance metrics for the final model in segmenting
...
\begin{table}[H]
    \centering
    \caption[Performance metrics for the final model in the test
        dataset]{Performance metrics for the final model in segmenting
